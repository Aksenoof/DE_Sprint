#парсинг данных о вакансиях python разработчиков с сайта hh.ru с использованием driver Safari
...
for page in range (1,40):
    ...
    url = 'https://hh.ru/search/vacancy?text=python+%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%87%D0%B8%D0%BA&salary=&clusters=true&area=113&ored_clusters=true&enable_snippets=true&customDomain=1'
    driver.get(url)
    ...
    for iter in tqdm.tqdm(tag):
        ...
        data["data"].append({"title":title.text, "work_experience":work_experience.text, "salary":salary.text, "region":region[0]})
